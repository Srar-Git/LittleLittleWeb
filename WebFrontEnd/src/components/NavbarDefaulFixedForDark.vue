...
<template>
  <nav class="navbar navbar-expand-lg z-index-3 shadow-none navbar-transparent position-absolute  " style="top: 0%;width: 89%;background-color: black">
      ...
      <div class="grid-container ">
        ...
        <div class=" " style="background-color: #00bcd4" id="search-btn">
          <svg t="1695213574640"
        ...
        <div style="background-color: #0d6efd" class="container " id="search-input">
          <MaterialInput
        ...
        <div class="  " id="navigation" style="background-color: #3aaf85">
          <div class="grid-dropdown-container " style="margin-top: 5%">
            <div class="nav-item dropdown dropdown-hover " style="background-color: grey;width: 100%">
              <a
                  role="button"
            ...
            <div class="align-items-end" style="background-color: black;">
              <a
            ...
            <div class="align-items-end" style="background-color: greenyellow">
