...
<template>
        <div class="detailBox tcommonBox" >
            <span class="s-round-date">
                <span class="month" v-html="detailObj.createTime+'月'"></span>
                <span class="day" v-html="detailObj.createTime"></span>
            </span>
            <header>
                <h1>
                    <a :href="'#/DetailShare?aid='+detailObj.id" target="_blank">
                        {{detailObj.articleTitle}}
                    </a>
                </h1>
                <h2>
            ...
            <div class="article-content markdown-body" v-html="detailObj.articleContent"></div>
